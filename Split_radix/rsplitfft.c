 ...
 *                                                                            *
 * published in H.V. Sorensen, D.L. Jones,                                    *
 ...
 * Modified and test: Amin Sahebi. University of Siena, sahebi@diism.unisi.it *
 *****************************************************************************/
...
int main(void)
{
	...
	printf("[INFO] execution time: %.6f us\n", (t2-t1)/Num_Iterations);
#ifdef DEBUG	
	for(int i=1 ; i<=8 ; i++)
		printf("[INFO] The Split-radix Outputs are %f \n",x[i]);
#endif
	return 0;
}
